 ...
 * 热图截屏页面关闭
 */
- (void)heatMap:(DAHeatMap*)heatMap didCloseSnapshotView:(UIView*)snapshotView;
...
@property(nonatomic, strong, readonly) DAHeatMapBubbleView                  *bubbleView;
